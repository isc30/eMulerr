...
COPY ./src/amule/amule.overrides.conf /config/amule/amule.overrides.conf
COPY ./src/amule/merge_overrides.sh /config-base/amule/merge_overrides.sh
RUN chmod +x /config-base/amule/merge_overrides.sh
